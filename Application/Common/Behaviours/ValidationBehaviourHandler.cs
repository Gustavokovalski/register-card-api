...
public class ValidationBehaviourHandler<TRequest, TResponse> : IPipelineBehavior<TRequest, TResponse> where TRequest : IRequest<TResponse>
{
    private readonly IEnumerable<IValidator<TRequest>> _validators;

    public ValidationBehaviourHandler(IEnumerable<IValidator<TRequest>> validators)
    {
